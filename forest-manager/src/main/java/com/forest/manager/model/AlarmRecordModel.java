package com.forest.manager.model;
...
public class AlarmRecordModel {
     ...
     * 是否经过处理，未处理 处理中 已处理
     */
    private String isHandledContent;
     ...
     * 火灾报警状态 正 误 漏
     */
    private String almStatusContent;
    ...
    public String getIsHandledContent() {
        return isHandledContent;
    }

    public void setIsHandledContent(String isHandledContent) {
        this.isHandledContent = isHandledContent;
    }
    ...
    public String getAlmStatusContent() {
        return almStatusContent;
    }

    public void setAlmStatusContent(String almStatusContent) {
        this.almStatusContent = almStatusContent;
    }
